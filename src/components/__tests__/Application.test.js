...
import { fireEvent, waitForElement, getByText, prettyDOM, getAllByTestId, getByPlaceholderText, getByAltText, act, queryByText, queryByAltText } from "@testing-library/react";
...
describe("Application", () => {
  ...
  it("shows the delete error when failing to delete an existing appointment", async () => {
    ...
    expect(queryByText(appointment, "Could not cancel appointment")).not.toBeInTheDocument();
  });
});